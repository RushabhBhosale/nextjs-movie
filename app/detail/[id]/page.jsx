  ...
  return (
    <>
      <div className='w-full relative overflow-auto pages bg-black'>
        <TopSpace />
        {movie && <Image className='hidden sm:block z-0 relative object-cover rounded-tl-3xl' alt='backdrop' src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path}`} fill sizes={100} />}
          ...
          <div className='z-30'>
            ...
            <div className='mt-8 px-4'>
              ...
              {videos && videos.results.length > 0 ? (
                ...
                <div className='text-3xl sm:mx-72 text-red-700 my-20'>No Videos Available</div>
              )}
              <div className='text-4xl ps-40 mt-6 hidden sm:block text-white'> You may also like</div>
            </div>
          </div>
        </div>
        <div className='text-4xl ps-2 sm:hidden text-white'> You may also like</div>
